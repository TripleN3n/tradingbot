    ...
    def bot_start(self, version: str, mode: str, initial_capital: float,
        ...
        self.log("bot_start", "system", {
            ...
            "config_summary": {
                ...
                "max_leverage":   config_snapshot.get("MAX_LEVERAGE"),
                "slot_pct":       config_snapshot.get("CAPITAL_PER_SLOT"),
                "drawdown_alert": config_snapshot.get("DRAWDOWN", {}).get("alert_pct"),
                "drawdown_pause": config_snapshot.get("DRAWDOWN", {}).get("pause_pct"),
                "drawdown_stop":  config_snapshot.get("DRAWDOWN", {}).get("stop_pct"),
            },
        })
